...
class Trade1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OprationAppbar(
              ...
              child: TextButton(
                  onPressed: () {
                    Navigator.of(context)
                        .popUntil((route) => route.settings.name == Trade2.id);
      ...
      FutureBuilder<List<TradeModel>>(
          future: TradeController.getAll(),
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                          ...
                          height: 160,
                          padding: EdgeInsets.only(
                              top: 20, bottom: 30, right: 0, left: 0),
