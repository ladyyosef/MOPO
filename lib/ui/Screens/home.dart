                         ...
                         children: [
                          ...
                          Container(
                               ...
                               children: [
                                 Column(
                                   ...
                                   Container(
                                       width: 190,
                                       height: 190,                                     child:
                                          Image.asset('assets/images/HomeRopot.png'))
                                 ]),
                           ),
                           Container(
                           ...
                           GestureDetector(
                               ...
                               child: Column(children: [
                                 ...
                                 Row(
                                   ...
                                   children: [
                                     ...
                                     IconButton(
                                      iconSize: 25,icon: Icon(Icons.arrow_drop_down),
                                      onPressed: () {
                                        // ...
                                       },
                                     )
                             ...
                             onTap: () {
                                Navigator.of(context).popUntil((route) => route.settings.name == Price_Alrte.id);
