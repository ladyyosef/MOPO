...
import 'admin_wallet7.dart';
import 'home.dart';


class AdaminWallet3 extends StatelessWidget {
   AdaminWallet3({key});
   var CvcController = TextEditingController();
    ...
    static String id = "AdaminWallet3";
            ...
            child: Row(
              ...
              children: [
                ...
                borderRadius: BorderRadius.circular(15),
                  ...
                  child: TextButton(
                  onPressed: () {
                    Navigator.of(context).popUntil((route) => route.settings.name ==AdminWallet7.id);
Navigator.pushNamed(context, AdminWallet7.id); 
