            ...
            child: Row(
              children: [
                IconButton(
                    onPressed: () {
                      Navigator.push(
                          context, MaterialPageRoute(builder: (_) => Trade()));
                    },
          ...
          Column(children: [
            Column(
              children: [
                ...
                Container(
                  padding:
                      EdgeInsets.only(top: 35, bottom: 10, right: 160, left: 5),
                  child: Text(
                    'Verification code',
                    style: TextStyle(
                        fontSize: 25,
                ...
                Container(
                  padding:
                      EdgeInsets.only(top: 1, left: 13, right: 15, bottom: 30),
                  child: Text(
            ...
            MaterialButton(
              ...
              child: Container(
                padding:
                    EdgeInsets.only(top: 80, left: 200, right: 11, bottom: 50),
                child: Text(
                  'Not Sent',
                  style: TextStyle(
                      fontSize: 18,
