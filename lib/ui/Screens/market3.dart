...
class _Market3State extends State<Market3> {
  ...
  void initState() {
    ...
    TrendingController.getcurrency()
        ...
        onTap: () async {
          ...
          if (Search.text.isNotEmpty) {
            streamControlelr.sink
                .add(await TrendingController.getcurrency(Search.text));
          }
        },
      ),
      Container(
              ...
              children: [
                  ...
                  (curr) => GestureDetector(
                    ...
                    onTap: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (_) => Etherem()));
                    },
                  ),
                ),
                SizedBox(
                ...
                ...currency.map(
                  (curr) => GestureDetector(
                    ...
                    onTap: () {
                      Navigator.push(
                          context, MaterialPageRoute(builder: (_) => Neo()));
                    },
                  ),
                ),
                SizedBox(
                ...
                ...currency.map(
                  (curr) => GestureDetector(
                    ...
                    onTap: () {
                      Navigator.push(
                          context, MaterialPageRoute(builder: (_) => Xrp()));
                    },
                  ),
                ),
              ],
