...
class SendVar2 extends StatelessWidget {
  SendVar2({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return OprationAppbar(
      ...
      children: [
        ...
        SizedBox(height: 10),
        Container(
          padding: EdgeInsets.only(top: 35, bottom: 10, right: 100, left: 10),
          child: Text(
            'Verification wallet',
        ...
        Container(
          ...
          child: TextButton(
              onPressed: () {
                ...
                Navigator.push(
                    context, MaterialPageRoute(builder: (_) => SendVar3()));
              },
              child: Text(
                'Next',
